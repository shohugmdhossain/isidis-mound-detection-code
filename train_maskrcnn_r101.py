...
MY_OUTPUT = "/work/shohug/maskrcnn_new_project/outputs/maskrcnn_mounds_r101_20k"
...
# Base our config on a standard ResNet-101 Mask R-CNN model from the model zoo.
